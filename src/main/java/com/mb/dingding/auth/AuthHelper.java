...
import com.mb.dingding.common.Env;
import com.mb.dingding.common.OApiException;
import com.mb.dingding.utils.FileUtils;
...
public class AuthHelper {
	...
	/**
	 * 在此方法中，为了避免频繁获取access_token， 在距离上一次获取access_token时间在两个小时之内的情况， 将直接从持久化存储中读取access_token <br />
	 * 因为access_token和jsapi_ticket的过期时间都是7200秒 所以在获取access_token的同时也去获取了jsapi_ticket <br />
